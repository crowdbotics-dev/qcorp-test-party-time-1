"""
Django settings for qcorp_test_party_time_1 project.
...
ROOT_URLCONF = 'qcorp_test_party_time_1.urls'
...
WSGI_APPLICATION = 'qcorp_test_party_time_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "qcorp_test_party_time_1 API",
    "DESCRIPTION": "API documentation for qcorp_test_party_time_1 App",
    "VERSION": "v1",
}

...
## Project Structure
    ...
    ├── qcorp_test_party_time_1  # Django project configurations
...
1. Clone this repo and `cd qcorp_test_party_time_1`
...
2. Clone this repo and `cd qcorp_test_party_time_1`
